...
def moist_lapse_serial(pressure, parcel_temperature, moist_adiabat_lookup, moist_adiabats,
...
def moist_lapse_single_point(pressure, parcel_temperature, moist_adiabat_lookup, moist_adiabats,
